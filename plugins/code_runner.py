...
@cpbot_on_cmd(
    cmd=["exec", "eval"],
    ignore_errors=True,
    cmd_help={"help": "Run Python Code!", "example": '{ch}eval print("cpbot")'},
)
...
@cpbot_on_cmd(
    ...
    cmd_help={
        ...
        "example": "{ch}run python print('cpbot')",
    },
)
...
`{ret}`
"""
    await edit_or_send_as_file(cpbot, stark, client, cmd, "bash-result")
