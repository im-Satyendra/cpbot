...
# button post makker for cpbot thanks to uniborg for the base
# by @casperteam (@cpbot)
import os
import re
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.cbutton test [google]<buttonurl:https://www.google.com> [cpbot]<buttonurl:https://t.me/cpbot17:same> [support]<buttonurl:https://t.me/cpbot_support>`\
    \n\n•  **Syntax : **`.ibutton`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.ibutton test [google]<buttonurl:https://www.google.com> [cpbot]<buttonurl:https://t.me/cpbot17:same> [support]<buttonurl:https://t.me/cpbot_support>`\
    "
    }
)
