...
if "cpbot" in _RUN(_MGCLIENT.list_database_names()):
    _LOG.info(_LOG_STR, "cpbot Database Found :) => Now Logging to it...")
else:
    _LOG.info(_LOG_STR, "cpbot Database Not Found :( => Creating New Database...")

_DATABASE: AgnosticDatabase = _MGCLIENT["cpbot"]
