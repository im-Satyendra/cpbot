...
from cpbot import cpbot, Message, Config, pool
from cpbot.utils import humanbytes, time_formatter
from cpbot.utils.exceptions import ProcessCanceled

_LOG = cpbot.getLogger(__name__)
...
@cpbot.on_cmd('drename ([^|]+)\|([^|]+)', about={  # noqa
...
@cpbot.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
