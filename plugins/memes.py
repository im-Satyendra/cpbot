# cpbot module for having some fun with people.
...
async def source(e):
    await edit_or_reply(
        e,
        "Click [here](https://github.com/casperteam/cpbot) to open this bot source code\
        \nClick [here](https://github.com/casperteam/catpack) to open supported link for heroku",
    )
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `.repo`\
        \n  •  **Function : **Shows to source code link of cpbot.\
        \n\n  •  **Syntax :** `.lfy <query>`\
