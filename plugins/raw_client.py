...
import cpbot  # pylint: disable=unused-import

_LOG = cpbot.logging.getLogger(__name__)
...
class RawClient(Client):
    ...
    def __init__(self, bot: Optional['cpbot.core.client.cpbotBot'] = None, **kwargs) -> None:
        self._bot = bot
        super().__init__(**kwargs)
        self._channel = cpbot.core.types.new.ChannelLogger(self, "CORE")
        cpbot.core.types.new.Conversation.init(self)
