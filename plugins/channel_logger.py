...
from cpbot.utils import SafeDict, get_file_id_of_media, parse_buttons
...
class ChannelLogger:
    """ Channel logger for cpbot """
    def __init__(self, client: Union['_client.cpbot', '_client.cpbotBot'], name: str) -> None:
    ...
    async def forward_stored(self,
                             client: Union['_client.cpbot', '_client.cpbotBot'],
                             message_id: int,
                             chat_id: int,
                             user_id: int,
        ...
        Parameters:
            client (`cpbot` | `cpbotBot`):
                Pass cpbot or cpbotBot.
