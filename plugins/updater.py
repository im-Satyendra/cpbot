...
if Config.UPSTREAM_REPO == "goodcat":
    UPSTREAM_REPO_URL = "https://github.com/casperteam/cpbot"
elif Config.UPSTREAM_REPO == "badcat":
    UPSTREAM_REPO_URL = "https://github.com/Jisan09/cpbot"
else:
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond("do `.update deploy` to update the cpbot")
...
async def upstream(event):
    ...
    off_repo = "https://github.com/casperteam/catpack"
    os.chdir("/app")
    catcmd = f"rm -rf .git"
    try:
...
async def variable(var):
    ...
    heroku_var["UPSTREAM_REPO"] = "https://github.com/Jisan09/cpbot"
